...
pub struct GitHubBanner {}

impl Component for GitHubBanner {
    type Message = ();
    type Properties = ();
    ...
    fn view(&self) -> Html {
        html! {
            <a href="https://github.com/tracehelms/word-guess-rust-yew-wasm" class="github-corner" aria-label="View source on GitHub">
